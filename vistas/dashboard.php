...
// Simulación de datos de QuickBooks (reemplaza esto con tu API real)
require_once __DIR__ . '/../src/quickbooks_api.php';
$clientes = obtenerClientes(); // Debe retornar array con 'nombre' y 'deuda'

function calcularDeudaTotal($clientes) {
    return array_sum(array_column($clientes, 'deuda'));
}

// Tomar los 5 clientes con mayor deuda
...
<div class="container py-5">
  ...
  <a href="../autorizar.php" class="btn btn-success">
    <i class="fa-brands fa-intuit me-2"></i> Autorizar acceso
	<a href="desconectar.php" class="btn btn-danger">
  <i class="fa-solid fa-plug-circle-xmark me-1"></i> Desconectar QuickBooks
</a>
  </a>
</div>
    </div>
